...
// 게시글 목록 ( 전체 조회 )
// { page = 0, size = 0, keyword = '' } 서버에서 넘기는 값이 없는 경우 자바스크립트에서 정한 기본값으로 사용 

export async function fetchPosts({ page = 0, size = 0, keyword = '' }) {
...
// 게시글 상세
export async function fetchPostsDetail(postId) {
